...
**Memory line:** An adversarial attack is not necessarily a tiny step into a strange nonlinear trap; it can be many tiny, coordinated pushes that add up in same harmful direction.
