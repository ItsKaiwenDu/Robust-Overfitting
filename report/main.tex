...
\begin{figure}[htbp]
  ...
  The training curves combine measurements from different attack domains
  across seeds and epochs. They show performance against the attack used for
  training each model at that time; they do not measure joint accuracy under
  both attacks.}
