...
256-image test subset. PGD-20 uses one random restart; for PGD-50, the
per-example candidate with the highest cross-entropy loss among three random
restarts is used. Accuracy is in percent.}
