...
cutoff and attack settings. A useful next experiment would mix attacks at the
batch or example level, select checkpoints using a validation set, and
evaluate them with a broader attack suite.
...
restarts is used. Accuracy is in percent. $\Delta$ is PGD-50 accuracy minus
